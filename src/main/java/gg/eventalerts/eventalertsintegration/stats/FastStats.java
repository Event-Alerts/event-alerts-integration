...
public class FastStats extends FastStatsLoader {
    ...
    public void mutateMetricsFactory(@NotNull Metrics.Factory factory) {
        ...
        factory
                ...
                .addMetric(Metric.string("config_event_messages_sound_sound_category", () -> plugin.config.event_messages.sound.sound.category != null ? plugin.config.event_messages.sound.sound.category.name(): null))
                ...
                .addMetric(Metric.stringArray("config_event_messages_ignored_formats", () -> plugin.config.event_messages.ignored_formats.stream()
                        .map(Enum::name)
                        .toArray(String[]::new)))
                .addMetric(Metric.stringArray("config_event_mesages_host_filter", () -> plugin.config.event_messages.host_filter.toArray(String[]::new)))
