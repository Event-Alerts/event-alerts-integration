...
public class EAConfigValidator implements ConfigValidator {
    @NotNull private final EAValidator validator;

    public EAConfigValidator() {
        this(false);
    }

    public EAConfigValidator(boolean defaultNotNull) {
        this.validator = EAValidator.of(defaultNotNull ? NullPolicy.NOT_NULL : NullPolicy.NULLABLE);
    }
